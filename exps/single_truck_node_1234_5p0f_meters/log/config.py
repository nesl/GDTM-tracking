...
hdf5_fnames = [
    ...
    '/home/csamplawski/data/mmm/2022-09-01/node_2/zed.hdf5',
    '/home/csamplawski/data/mmm/2022-09-01/node_3/zed.hdf5',
...
valset = dict(
    ...
    vid_path='exps/single_truck_node_1234_5p0f_meters/',
    max_len=-1,
    limit_axis=False,
    draw_cov=True)
data = dict(
...
work_dir = 'exps/single_truck_node_1234_5p0f_meters/log'
gpu_ids = [0]
